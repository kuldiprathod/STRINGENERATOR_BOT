...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/kuldiprathod/STRINGENERATOR_BOT)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/kuldiprathod/STRINGENERATOR_BOT
   ```
